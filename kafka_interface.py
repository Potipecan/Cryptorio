...
class KafkaInterface:
    ...
    def start(self, args, has_output: bool = True):
        ...
        if len(self.input_topics) > 0:
            ...
            self.consumer_thread = threading.Thread(target=self.consumer_thread_work)
    ...
    def stop(self):
        ...
        if self.consumer is not None and self.consumer.bootstrap_connected():
            self.consumer.close()
